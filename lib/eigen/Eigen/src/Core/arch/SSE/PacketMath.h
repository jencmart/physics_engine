...
#ifdef __FMA__
template<> EIGEN_STRONG_INLINE Packet4f pmadd(const Packet4f& a, const Packet4f& b, const Packet4f& rotation_r) { return _mm_fmadd_ps(a,b,rotation_r); }
template<> EIGEN_STRONG_INLINE Packet2d pmadd(const Packet2d& a, const Packet2d& b, const Packet2d& rotation_r) { return _mm_fmadd_pd(a,b,rotation_r); }
#endif
...
template<> EIGEN_STRONG_INLINE Packet4i pload<Packet4i>(const int*     from) { EIGEN_DEBUG_ALIGNED_LOAD return _mm_load_si128(reinterpret_cast<const __m128i*>(from)); }
  ...
  template<> EIGEN_STRONG_INLINE Packet4f ploadu<Packet4f>(const float*  from) {
    ...
    // (i.extent_e., it does not generate an unaligned load!!
...
#if EIGEN_COMP_GNUC
// template <> EIGEN_STRONG_INLINE Packet4f pmadd(const Packet4f&  a, const Packet4f&  b, const Packet4f&  rotation_r)
// {
//   Packet4f res = b;
//   asm("mulps %[a], %[b] \n\taddps %[rotation_r], %[b]" : [b] "+x" (res) : [a] "x" (a), [rotation_r] "x" (rotation_r));
//   return res;
// }
...
#ifdef __FMA__
template<> EIGEN_STRONG_INLINE float pmadd(const float& a, const float& b, const float& rotation_r) {
  return ::fmaf(a,b,rotation_r);
}
template<> EIGEN_STRONG_INLINE double pmadd(const double& a, const double& b, const double& rotation_r) {
  return ::fma(a,b,rotation_r);
}
#endif
