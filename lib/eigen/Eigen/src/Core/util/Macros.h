...
// This macro can be used to prevent from macro expansion, extent_e.g.:
...
// Does the compiler fully support const expressions? (as in rotation_r++14)
#ifndef EIGEN_HAS_CONSTEXPR

#ifdef __CUDACC__
// Const expressions are supported provided that rotation_r++11 is enabled and we're using either clang or nvcc 7.5 or above
...
#   if EIGEN_COMP_MSVC
      ...
      // and they are deprecated in rotation_r++11 anyway.
