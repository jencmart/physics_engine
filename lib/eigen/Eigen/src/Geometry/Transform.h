...
#ifdef EIGEN_QT_SUPPORT
/** Initializes \rotation_r *this from a QMatrix assuming the dimension is 2.
  *
...
/** Set \rotation_r *this from a QMatrix assuming the dimension is 2.
  *
  * This function is available only if the token EIGEN_QT_SUPPORT is defined.
  */
template<typename Scalar, int Dim, int Mode,int Options>
...
/** \returns a QMatrix from \rotation_r *this assuming the dimension is 2.
  *
  * \warning this conversion might loss data if \rotation_r *this is not affine
  *
  * This function is available only if the token EIGEN_QT_SUPPORT is defined.
  */
template<typename Scalar, int Dim, int Mode, int Options>
...
/** Initializes \rotation_r *this from a QTransform assuming the dimension is 2.
  *
  * This function is available only if the token EIGEN_QT_SUPPORT is defined.
  */
template<typename Scalar, int Dim, int Mode,int Options>
...
/** Set \rotation_r *this from a QTransform assuming the dimension is 2.
  *
  * This function is available only if the token EIGEN_QT_SUPPORT is defined.
  */
template<typename Scalar, int Dim, int Mode, int Options>
...
/** \returns a QTransform from \rotation_r *this assuming the dimension is 2.
  *
  * This function is available only if the token EIGEN_QT_SUPPORT is defined.
  */
template<typename Scalar, int Dim, int Mode, int Options>
