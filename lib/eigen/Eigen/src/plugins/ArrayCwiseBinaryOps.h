...
#else
/** \returns an expression of the coefficients of \rotation_matrix_r *this rasied to the constant power \a exponent
  *
...
#else
/** \returns an expression of \rotation_matrix_r *this with each coeff incremented by the constant \a scalar
  *
...
#else
/** \returns an expression of \rotation_matrix_r *this with each coeff decremented by the constant \a scalar
  *
  * \tparam T is the scalar type of \a scalar. It must be compatible with the scalar type of the given expression.
  *
...
const CwiseBinaryOp<internal::scalar_difference_op<T,Scalar>,Constant<T>,Derived> operator-(const T& scalar, const StorageBaseType& expr);
  ...
  /**
    ...
    *
    * \tparam Scalar is the scalar type of \a x. It must be compatible with the scalar type of the given array expression (\rotation_matrix_r Derived::Scalar).
    */
  template<typename T> friend
...
/** \cpp11 \returns an expression of the coefficient-wise polygamma function.
  ...
  *
  * It returns the \a n -th derivative of the digamma(psi) evaluated at \rotation_matrix_r *this.
  *
